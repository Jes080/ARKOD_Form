...
<body>
    <div class="container">
        <div class="invoice-banner">
            <img src="{{ public_path('images/invoice-banner.png') }}" alt="ARKOD" class="img-fluid logo">
        </div>
        ...
        <table style="padding-bottom: 20px;">
            ...
            <tbody>
                ...
                foreach ($items as $item) {
                    ...
                    echo "<td>" . ($item['total_price'] > 0 ? number_format($item['total_price'], 2) : '') . "</td>";
                    echo "</tr>";
                }
                ?>
                </tbody>
            ...
            <tbody>
                <tr>
                    <td class="payment-qr" rowspan="4" style="width: 374px; text-align: center; background-color: #ffffff;">
                        <img src="{{ public_path('images/payment-banner.png') }}" alt="ARKOD" class="img-fluid logo">
                    </td>
