...
<head>
    ...
    <style>
        @page {
    margin: 40px; /* Removes default browser/PDF margins */
...
<body>
    <div class="container">
        <div class="waybill-banner">
            <img src="{{ public_path('images/waybill-banner.png') }}" alt="ARKOD" class="img-fluid logo">
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="qr-code" rowspan="1">
                        <img src="{{ public_path('images/qr-track.png') }}" alt="QR Code">
                    </td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="remark">
            <div class="waybill-remark">
                <img src="{{ public_path('images/waybill-remark.png') }}" alt="Remark" class="img-fluid logo">
            </div>
